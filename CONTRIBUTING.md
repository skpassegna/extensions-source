...
free to report it through a [Meta Issue](https://github.com/skpassegna/extensions-source/issues/new?assignees=&labels=Meta+request&template=06_request_meta.yml) 
...
[`lib-dataimage`](https://github.com/skpassegna/extensions-source/tree/main/lib/dataimage) is a library 
...
[`lib-i18n`](https://github.com/skpassegna/extensions-source/tree/main/lib/i18n) is a library for handling
...
To get the current `id` value before the name change, you can search the source name in the [repository JSON file](https://github.com/skpassegna/Mihon-extensions/blob/repo/index.json)
